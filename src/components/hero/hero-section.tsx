        ...
        <div className="flex flex-col lg:flex-row items-center gap-8">
          ...
          <div className="flex-1 w-full max-w-xl">
            ...
            <p className="mt-7 text-base md:text-lg text-neutral-400 leading-relaxed max-w-lg">
              Real-time patrol monitoring using Bluetooth technology and
              Scanner devices. Track guard checkpoints, verify patrol
            ...
            <div className="mt-12 pt-8 border-t border-white/[0.06]">
              <dl className="grid grid-cols-3 gap-6 max-w-xl">
                <Capability icon={FiRadio}        label="Bluetooth Scanning"     hint="continuous detect" />
